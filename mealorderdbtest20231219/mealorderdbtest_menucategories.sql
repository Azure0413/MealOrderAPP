...
CREATE TABLE `menucategories` (
  ...
  `menuId` int NOT NULL,
  `menuCategoryName` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`menuCategoryId`),
  KEY `menuId` (`menuId`),
  CONSTRAINT `menucategories_ibfk_1` FOREIGN KEY (`menuId`) REFERENCES `menus` (`menuId`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `menucategories` VALUES (1,1,'麵食'),(2,1,'米食'),(3,1,'湯品'),(4,1,'小菜'),(5,2,'手工沾醬'),(6,3,'低糖甜點預購');
